...
step1Logic = cell2mat(out(:,6))==1;
step2Logic = cell2mat(out(:,6))==2;
step1Time = 0.02;

T = [0; cell2mat(out(step1Logic,2))*step1Time; step1Time+cell2mat(out(step2Logic,2))];
